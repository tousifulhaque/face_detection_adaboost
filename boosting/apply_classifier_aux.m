...
%                                        weak_classifiers, face_size)
% This function returns a matrix of detection response value for each pixel
% location. High response values mean a high probability that pixel
% location is the center of the object to be detected (e.g. a face).
