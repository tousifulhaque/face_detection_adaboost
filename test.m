...
for i = 1:size(test_data,3)
    ...
    [max_response , ~] = boosted_multiscale_search(image, 1, best_classifiers, weak_classifiers, [face_horizontal, face_vertical]);
...
disp([false_negative, false_positive, accuracy]);
